        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="content2">
                        <Select v-model="searchForm.content2" placeholder="安检结果" clearable style="width: 150px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getSecurityCheckList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
