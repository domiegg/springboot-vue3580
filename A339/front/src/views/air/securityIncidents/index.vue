            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="事件名称" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="事件介绍" clearable style="width: 150px" />
                    </Form-item>
...
<script>
import {
    getSecurityIncidentsList,
    deleteSecurityIncidents
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getSecurityIncidentsList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
