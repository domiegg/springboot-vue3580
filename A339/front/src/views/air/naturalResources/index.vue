            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="资源介绍" clearable style="width: 150px" />
                    </Form-item>
...
<script>
import {
    getNaturalResourcesList,
    deleteNaturalResources
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getNaturalResourcesList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
