    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <FormItem label="起飞时间" prop="time1">
                <DatePicker type="datetime" format="yyyy-MM-dd HH:mm" @on-change="changeTime1" clearable placeholder="请选择起飞时间..." style="width:570px"></DatePicker>
            </FormItem>
            <FormItem label="到达时间" prop="time2">
                <DatePicker type="datetime" format="yyyy-MM-dd HH:mm" @on-change="changeTime2" clearable placeholder="请选择到达时间..." style="width:570px"></DatePicker>
            </FormItem>
