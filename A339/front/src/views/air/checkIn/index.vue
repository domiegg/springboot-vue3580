            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="userName">
                        <Input type="text" v-model="searchForm.userName" placeholder="乘客" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="luggage">
                        <Input type="text" v-model="searchForm.luggage" placeholder="航班号" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getCheckInList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
